...
function Sidebar() {
  ...
  return (
    <aside
      id="logo-sidebar"
      className={`fixed left-0 top-0  h-screen w-64 -translate-x-full bg-gradient-to-b from-[rgb(1,20,42)] from-20% to-[#00387B] pt-60 transition-transform sm:translate-x-0
