...
function Sidebar() {
  ...
  return (
    <aside
      id="logo-sidebar"
      className={`fixed top-0 z-10 left-0 w-64 h-screen transition-transform -translate-x-full pt-60 sm:translate-x-0 bg-gradient-to-b from-[rgb(1,20,42)] from-20% to-[#00387B]
